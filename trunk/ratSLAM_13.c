...
void mapCorrection()
{
    ...
    {
    	char linkValue = startExperience.outLinks[yMap];
      if(linkValue >= 0)
      {
...
task main ()
{
	nxtDisplayCenteredTextLine(3, "Roaming-13");
  ...
  nCurrState = stateStop;
  nWallState = stateStop;
	while(nextID<(numOfExperiences) && nextLink<70)
	{
  ...
  //Problems
  /*
    Need to play around with loop closure variables and wall follower
    wall follower pretty good
